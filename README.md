...
![Клонирование и пулл репозитория](screenshots/1.png)
...
![История операций](screenshots/2.png)
...
![Последние операции](screenshots/3.png)
...
![Удаление побочной ветки](screenshots/5.png)


### Задание 11
Был 2 раза изменён файл "newfile.txt", все изменения были закоммичены.
* git status
* git add
* git commit -m ""

![Изменения файлов](screenshots/6.png)
...
![Откат последнего коммита](screenshots/7.png)
...
![Создание ветки для отчёта](screenshots/8.png)
